                    ...
                    <form action="/shopping02" method="POST">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="order-list py-5">
                                        ...
                                        <div class="order-item-number">
                                            ...
                                            <div class="order-item-qty">
                                                <button type="button" class="order-reduce" data-id="{{$item->id}}">-</button>
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="order-items-fee">
                                    <div class="order-item-fee">
                                        ...
                                        <div class="hr2"></div>
                                        <select class="custom-select my-2 mr-sm-2" id="ship_way" name="ship_way" onclick="changefee(this)">
                            ...
                            <div class="order-item-step">
                                <button type="submit"><a href="./index.html" class=""><i
                                            class="fas fa-chevron-left"></i> 返回購物</a></button>
    ...
    <script>
        function changefee(value){
            ...
            if(subtotal >= 1000){
                ...
                document.querySelector('.total').innerHTML ="$" + (parseInt(document.querySelector('.subtotal').innerHTML.substring(1,99)) + 60)
                }else{
                document.querySelector('.fee').innerHTML = "$100"
                document.querySelector('.total').innerHTML ="$" + (parseInt(document.querySelector('.subtotal').innerHTML.substring(1,99)) + 100)
                }
            }
        }
    </script>
